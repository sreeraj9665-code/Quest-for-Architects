  ...
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 text-center px-6 max-w-6xl mx-auto">
        ...
        ease: [0.4, 0, 0.2, 1]
          ...
          <Button onClick={() => scrollToSection('problem')} size="lg" className="font-orbitron font-bold text-lg px-12 py-6 bg-primary text-primary-foreground hover:shadow-neon transition-all duration-300 animate-glow-pulse">DISCOVER THE MISSION </Button>
        </motion.div>
      </div>
